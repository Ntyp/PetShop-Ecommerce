<?php
    ...
    $sqlnew = "SELECT  * FROM stock ORDER BY stock . product_ID DESC limit 8";
...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #149c82;">
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="./img/S__12500994.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="./img/Banner_No_Bag_Web_Banner_1980x728.webp" class="d-block w-100" alt="...">
              </div>
            </div>
    ...
    <section>
        <div class="container">
            <div class="row">
                <h2 class="text-content mt-5"><b>เลือกประเภทสินค้าที่ต้องการ</b></h2>
                <div class="col-6">
                    <div class="typeProduct">
                        <a href="small_size.php">
                            <img class="mt-4" style="width:100%" src="./img/categories_Chaga.jpg" alt="">
                        </a>
                        <h3>ที่นอนชูก้าไรเดอร์</h3>
                    </div>
                    <div class="typeProduct">
                        <a href="medium_size.php">
                            <img class="mt-4" style="width:100%"  src="./img/S__3768326.jpg" alt="">
                        </a>
                        <h3>ที่นอนแมว</h3>
                    </div>
                </div>
                <div class="col-6">
                    <div class="typeProduct">
                        <a href="big_size.php">
                            <img class="mt-4" style="width:100%" src="./img/S__3760138.jpg" alt="">
                        </a>
                        <h3>ที่นอนสุนัข</h3>
                    </div>
                    <div class="typeProduct">
                        <a href="jumbo_size.php">
                            <img class="mt-4" style="width:100%" src="./img/S__3801097.jpg" alt="">
                        </a>
                        <h3>สัตว์ขนาดใหญ่พิเศษ</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section style="margin-bottom:100px">
        <div class="container">
            <div class="row">
            <h2 class="text-content mt-5"><b>รายการสินค้าล่าสุด</b></h2>
            <?php while($row11 = mysqli_fetch_array($resultnew)) { ?>
                <div class="col-3 mt-5">
                    <div class="card h-100 mt-5" style="width: 18rem;">
                        <a href="product_detail.php?Code=<?php echo "$row11[Code]" ?>"><img src="./img/<?php echo $row11['Img'] ?>" class="card-img-top" alt="..."></a>
                        <div class="card-body ">
                            <a style="text-decoration: none;" href="product_detail.php?Code=<?php echo "$row11[Code]" ?>"><h5 style="color:#5c7534!important;" class="card-title"><?php echo $row11['Name'] ?></h5></a>
                            <p class="card-text"><?php echo $row11['Detail'] ?></p>
                            <!-- <a class="btn btn-primary" 
                            style="background: #5c7534;border-color: #fff;border-width: 1px;border-radius: 4px;padding: 9px 12px;color: #FFF;" 
                            href="product_detail.php?Code=<?php echo "$row[Code]" ?>"><i class="fas fa-shopping-cart"></i> สั่งซื้อสินค้า</a> -->
                        </div>
                    </div>
                </div>
            <?php 

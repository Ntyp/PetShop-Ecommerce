<?php
    ...
    if(isset($_POST['btnupdate'])) {
        ...
        $sql1 = "UPDATE user SET email = '$user_email' , phone = '$user_phone' , address = '$user_address' ,
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-2"></div>
                    <div class="col-2">
                        <img style="width:100%;margin-top:70px;" src="./img/ava.png" alt="">
                    </div>
                    <div class="col-6">
                    <h3 class="mt-5">โปรไฟล์ส่วนตัว</h3>

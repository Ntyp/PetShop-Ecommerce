<?php
    ...
    if(isset($_POST['btnupdate'])) {
        ...
        echo '<script>alert("ทำรายการสำเร็จ");location.href="mange_member.php";</script>';
    }
?>
...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #149c82;">
    ...
    <section>
        <div class="container">
            <div class="row mt-5">
                <h3>ปรับสถานะผู้ใช้งาน</h3>
                <div class="row">
                    <div class="col-4">
                        <form action="" method="POST">
                            <span>ไอดีสมาชิก</span><input name="username" id="username" class="form-control mt-3" type="text">
                            <span>สถานะ</span><select class="form-control mt-3" name="status" id="status">
                                <option value="Admin">แอดมิน</option>
                                <option value="User">ยูเซอร์</option>
                            </select>
                            <input class="btn btn-success mt-3" name="btnupdate" id="btnupdate" type="submit" value="ยืนยัน">
                        </form>
                    </div>
                    <div class="col-6">
                        <h3>ข้อมูลสมาชิก</h3>
                        <table class="table table-bordered mt-3">
                            ...
                            <tr>
                                <td><b>ไอดีผู้ใช้งาน</b></td>
                                <td><b>พาสเวิร์ด</b></td>
                                <td><b>อีเมล์</b></td>
                                <td><b>เบอร์ติดต่อ</b></td>
                                <td><b>ที่อยู่</b></td>
                                <td><b>สถานะล่าสุด</b></td>
                            </tr>
                            <?php
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['address'] . $row['tambon'] . $row['amphoe'] . $row['province'] . $row['zipcode'] ?></td>

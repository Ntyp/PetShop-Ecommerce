<?php
    ...
    $sql = "SELECT * FROM stock WHERE Type = 'small' ORDER BY `Type` ASC"; //เรียกข้อมูลมาแสดงทั้งหมด
    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-12 mt-5">
                        <p class="mt-3">ขั้นตอนที่1: เข้าสู่หน้าแรกของเว็ปไซต์</p>
                        <img style="width:100%" src="./img/step1.PNG" alt="">
                    </div>
                    <div class="col-12 mt-5">
                        <p class="mt-3">ขั้นตอนที่2: ทำการลงทะเบียนเพื่อเข้าสู่ระบบ</p>
                        <img style="width:100%" src="./img/step2.PNG" alt="">
                    </div>
                    <div class="col-12 mt-5">
                        <p class="mt-3">ขั้นตอนที่3: เข้าสู่ระบบ</p>
                        <img style="width:100%" src="./img/step3.PNG" alt="">
                    </div>
                    <div class="col-12 mt-5">
                        <p class="mt-3">ขั้นตอนที่4: เลือกสินค้าที่ต้องการรับชม</p>
                        <img style="width:100%" src="./img/step4.PNG" alt="">
                    </div>
                    <div class="col-12 mt-5">
                        <p class="mt-3">ขั้นตอนที่5: หยิบสินค้าเข้าตะกร้า</p>
                        <img style="width:100%" src="./img/step5.PNG" alt="">
                    </div>
                    <div class="col-12 mt-5">
                        <p class="mt-3">ขั้นตอนที่6: เช็คสินค้าในตะกร้า</p>
                        <img style="width:100%" src="./img/step6.PNG" alt="">
                    </div>
                    <div class="col-12 mt-5">
                        <p class="mt-3">ขั้นตอนที่7: กรอกที่อยู่การจัดส่ง</p>
                        <img style="width:100%" src="./img/step7.PNG" alt="">
                    </div>
                    <div class="col-12 mt-5">
                        <p class="mt-3">ขั้นตอนที่8: เช็คสถานะออเดอร์</p>
                        <img style="width:100%" src="./img/step8.PNG" alt="">
                    </div>
                    <div class="col-12 mt-5">
                        <p class="mt-3">ขั้นตอนที่9: ชำระค่าสินค้า</p>
                        <img style="width:100%" src="./img/step9.PNG" alt="">
                    </div>
                    <div class="col-12 mt-5">
                        <p class="mt-3">ขั้นตอนที่10: กรอกรายละเอียดการโอน</p>
                        <img style="width:100%" src="./img/step10.PNG" alt="">
                    </div>
                    <div class="col-12 mt-5">
                        <p class="mt-3">ขั้นตอนที่11: เมื่อชำระสินค้าเสร็จจะต้องรอแอดมินส่งของจึงจะปรับสินค้าเป็นพัสดุถูกจัดส่ง</p>
                        <img style="width:100%" src="./img/step11.PNG" alt="">
                    </div>
                    <div class="col-12 mt-5">
                        <p class="mt-3">ขั้นตอนที่12: สามารถเช็คใบสั่งซื้อสินค้าได้</p>
                        <img style="width:100%" src="./img/step12.PNG" alt="">
                    </div>
                </div>
            </div>
        </div>

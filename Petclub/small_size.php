...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #149c82;">
    ...
    <section style="margin-bottom:100px">
        <div class="container">
            <div class="row">
            <h2 class="text-content mt-5"><b>รายการสินค้า</b></h2>
                <?php
                ...
                <div class="col-3">
                    <div class="card h-100 mt-5" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h3 style="color:#5c7534!important;" class="card-title"><b><?php echo $row['Name'] ?></b></h3>
                            <p><u>รายละเอียดสินค้า</u></p>
                            <p class="card-text"><?php echo $row['Detail'] ?></p>
                            <a style="background: #5c7534;border-color: #fff;border-width: 1px;border-radius: 4px;padding: 9px 12px;color: #FFF;" style="background: #5c7534;border-color: #fff;border-width: 1px;border-radius: 4px;padding: 9px 12px;color: #FFF;" href="product_detail.php?Code=<?php echo "$row[Code]" ?>" class="btn btn-light"><i class="fas fa-shopping-cart"></i> สั่งซื้อสินค้า</a>
                        </div>
                    </div>
                </div>
                <?php 

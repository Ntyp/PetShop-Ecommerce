<?php
    ...
    if(isset($_POST['btnupdate'])) {
        ...
        $sql1 = "UPDATE member SET email = '$user_email' , phone = '$user_phone' , address = '$user_address' ,
        tambon = '$user_tambon' , amphoe = '$user_amphoe' , province = '$user_province' , zipcode = '$user_zipcode' 
        WHERE username = '$user'";
        echo $sql1;
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-2"></div>
                    <div class="col-2">
                        <img style="width:100%;margin-top:70px;" src="./img/albert-dera-ILip77SbmOE-unsplash.jpg" alt="">
                    </div>
                    <div class="col-6">
                    <h3 class="mt-5">แก้ไขโปรไฟล์ส่วนตัว</h3>
                        <form action="" method="POST">
                            <div class="row">
                                <div class="col">
                                    <span>อีเมล์</span><input class="form-control" name="user_email" id="user_email" type="text" value="<?php echo $row['email']; ?>">
                                </div>
                                <div class="col">
                                    <span>เบอร์ติดต่อ</span><input class="form-control" name="user_phone" id="user_phone" type="text" value="<?php echo $row['phone']; ?>">
                                </div>
                            </div>
                            
                            
                            <span>ที่อยู่</span><input class="form-control" name="user_address" id="user_address" type="text" value="<?php echo $row['address']; ?>">

                            <div class="row">
                                <div class="col">
                                    <span>ตำบล</span><input class="form-control" name="user_tambon" id="user_tambon" type="text" value="<?php echo $row['tambon']; ?>">
                                </div>
                                <div class="col">
                                    <span>อำเภอ</span><input class="form-control" name="user_amphoe" id="user_amphoe" type="text" value="<?php echo $row['amphoe']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <span>จังหวัด</span><input class="form-control" name="user_province" id="user_province" type="text" value="<?php echo $row['province']; ?>">
                                </div>
                                <div class="col">
                                    <span>รหัสไปรษณี</span><input class="form-control" name="user_zipcode" id="user_zipcode" type="text" value="<?php echo $row['zipcode']; ?>">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col">
                                    <input width="100%" class="btn btn-success" name="btnupdate" id="btnupdate" type="submit" value="บันทึก">
                                </div>
                            </div>
                        </form>
                </div>

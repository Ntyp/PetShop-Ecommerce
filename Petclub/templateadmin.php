...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #149c82;">
    <div class="container-fluid">
        <a class="navbar-brand" href="./index.php">PetClub</a>
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item" href="order.php">ออเดอร์</a></li>
                ...
                <li><a class="dropdown-item" href="">สถานะคำสั่งซื้อ</a></li>
                <li><a class="dropdown-item" href="">เช็คพัสดุ</a></li>
              </ul>
            </li>

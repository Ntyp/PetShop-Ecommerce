<?php
    ...
    if(isset($_POST['btndelete'])) {
        ...
        $delete_stock = "DELETE FROM stock_detail WHERE Code = '$Code'";
        $resultdelete_stock = mysqli_query($conn,$delete_stock);
        echo '<script>alert("ลบสินค้าสำเร็จ");location.href="delete_product.php";</script>';
            ...
            <div class="row mt-5">
                ...
                <form action="" method="POST">
                    <div class="row">
                        ...
                        <a class="mt-2" href="add_product.php">เพิ่มข้อมูลสินค้า</a>
                    </div>
                </form>

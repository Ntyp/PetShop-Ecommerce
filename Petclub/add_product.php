<?php
    ...
    if(isset($_POST['addbtn'])) {
        $sql = "INSERT INTO stock (product_ID,Code,Name,Oldprice,Price,Type,Detail,Img) VALUES 
        (null,'$code','$name','$oldprice','$price','$type','$detail','$img')";
        echo $sql;
        $result = mysqli_query($conn,$sql);
        echo '<script>alert("เพิ่มรายการสำเร็จ");location.href="add_product.php";</script>';
    }
                ...
                <form action="" method="POST">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <input name="name" id="name" class="form-control mt-1" type="text" required>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <input name="code" id="code" class="form-control mt-1" type="text" required>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            <span>หมวดหมู่</span>
                            <select name="type" id="type" class="form-control mt-1" name="" id="" required>
                                <option value="small">ชูก้าไรเดอร์</option>
                                <option value="medium">แมว</option>
                                <option value="big">หมา</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            <span>ราคาเก่า</span>
                            <input name="oldprice" id="oldprice" class="form-control mt-1" type="text" required>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <input name="price" id="price" class="form-control mt-1" type="text" required>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col">
                            <span>รายละเอียดสินค้า</span>
                            <textarea class="form-control mt-1" name="detail" id="detail" cols="30" rows="5" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <input name="img" id="img" class="form-control mt-3" type="file">
                        </div>
                    </div>
                    <!-- <button class="btn btn-success mt-3 float-end"><i class="fas fa-plus"></i> เพิ่มข้อมูลสินค้า</button> -->
                    <a class="mt-5" href="delete_product.php">ลบข้อมูลสินค้า</a>

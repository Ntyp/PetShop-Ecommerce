...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #149c82;">
   ...
   <section>
       <div class="container">
           <div class="row mt-5">
               <h3>ข้อมูลออเดอร์สินค้า</h3>
               <table class="table table-bordered">
                   <tr>
                       <td>คำสั่งซื้อเลขที่</td>
                       <td>ไอดีสมาชิกที่สั่ง</td>
                       <td>การชำระเงิน</td>
                       <td>หมายเลขพัสดุ</td>
                       <td>ใบเสร็จสินค้า</td>
                   </tr>
                   ...
                   <tr>
                       ...
                       <td><a class="btn btn-success" href="payment_admin.php?order_id=<?php echo $order_id?>">ตรวจสอบ</a></td>
                       <td><a class="btn btn-danger" href="give_postcode.php?order_id=<?php echo $order_id?>">แจ้งเลขพัสดุ</a></td>
                       <td><a class="btn btn-primary" href="./receipt.php?order_id=<?php echo $row['order_id']; ?>">พิมพ์ใบเสร็จ</a></td>
                   </tr>
                   <?php 
                        }
                    ?>

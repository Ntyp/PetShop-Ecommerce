<?php
    ...
    if(isset($_GET['logout'])){
        ...
        if(isset($_POST['contractbtn'])) {
            $sql = "INSERT INTO report (report_id,report_owner,report_phone,report_email,report_topic,report_detail)
            VALUE (null,'$Report_Name','$Report_Phone','$Report_Email','$Report_Topic','$Report_Detail')";
...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #149c82;">
    ...
    <div class="container">
        <div class="row">
            <h3 class="mt-3"><b><u>ติดต่อเรา</u></b></h3>
            <div class="col-md-12 mt-3">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3876.0781069414284!2d100.39288241527385!3d13.71371910186857!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e297cb33e5a655%3A0x783ee6fac7849bf9!2zNTc0IOC5gOC4nuC4iuC4o-C5gOC4geC4qeC4oSA5Mi8xIOC5geC4guC4p-C4hyDguJrguLLguIfguYHguITguYDguKvguJnguLfguK0g4LmA4LiC4LiV4Lia4Liy4LiH4LmB4LiEIOC4geC4o-C4uOC4h-C5gOC4l-C4nuC4oeC4q-C4suC4meC4hOC4oyAxMDE2MA!5e0!3m2!1sth!2sth!4v1633273186276!5m2!1sth!2sth" width="950" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            </div>
            <div class="col-md-6 mt-5">
                ...
                <form action="" method="POST">
                    ...
                    <div class="col-md-6">
                        <span class="mt-3">ชื่อผู้ติดต่อ</span>
                    ...
                    <div class="col-12 mt-3">                        
                        <button style="margin-bottom:40px" type="submit" name="contractbtn" id="contractbtn" class="btn btn-success float-end">ติดต่อเรา</button>
                    </div>
                    </div>
                </form>
            </div>
            <div class="col-6">
                <a href="#"><img style="width:50%;margin-top:90px" src="./img/Line-QR.jpg" alt=""></a>
                <a href="#"><img style="width:40%;margin-top:90px" src="./img/facebook--600.png" alt=""></a>
            </div>

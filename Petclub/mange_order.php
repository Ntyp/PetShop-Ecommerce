            ...
            <div class="row mt-5">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['order_owner'];?></td>
                        <td><?php echo $row['order_status'];?></td>
                        <td><a class="" href="order_detail_admin.php?order_id=<?php echo $row['order_id'];?>">ดูรายละเอียด</a></td>
                        <td><a class="btn btn-danger" href='mange_order.php?order_id=<?php echo $row['order_id']; ?>&act=remove'>ลบ</a></td>
                    </tr>
                    <?php 
                        }
                    ?>

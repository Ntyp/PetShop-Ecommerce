...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #149c82;">
    <div class="container-fluid">
        ...
        <div class="d-flex">
            ...
            <li style="list-style-type: none;" class="nav-item dropdown ">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li><a style="color:black" class="dropdown-item" href="edit_profile.php">ข้อมูลส่วนตัว</a></li>
    ...
    <section>
        <div class="container">
            ...
            <h3 class="mt-5"><b>โปรไฟล์ของฉัน</b></h3>
                <div class="row">
                    <div class="col-3">
                        <img style="width:100%;margin-top:70px;" src="./img/albert-dera-ILip77SbmOE-unsplash.jpg" alt="">
                    </div>
                    <div class="col-6" style="margin:70px 50px;">
                        <h3><u>ข้อมูลส่วนตัว</u></h3>
                        <p class="mt-3"><b>ชื่อ:</b> <?php echo $row['firstname']; ?> <span><b>นามสกุล:</b> <?php echo $row['lastname']; ?></span></p>
                        <p><b>อีเมล:</b> <?php echo $row['email']; ?> <span><b>เบอร์ติดต่อ:</b> <?php echo $row['phone']; ?></span></p>
                        <p><b>ที่อยู่:</b> <?php echo $row['address']; ?></p>
                        <p><b>ตำบล:</b> <?php echo $row['tambon']; ?><b> อำเภอ:</b> <?php echo $row['amphoe']; ?></p>
                        <p><b>จังหวัด:</b> <?php echo $row['province']; ?><b> รหัสไปรษณี:</b> <?php echo $row['zipcode']; ?></p>
